...
} from "./chunk-P3EFH5U5.js";
import {
  require_react_is
} from "./chunk-XTUN6MU4.js";
import {
  require_react
...
var isPlainObject = function(x) {
  return x !== null && typeof x === "object" && (x.toString ? x.toString() : Object.prototype.toString.call(x)) === "[object Object]" && !(0, import_react_is.typeOf)(x);
};
...
var CSSOMTag = function() {
  ...
  _proto.insertRule = function insertRule(index2, rule) {
    try {
      this.sheet.insertRule(rule, index2);
      this.length++;
      return true;
    } catch (_error) {
      return false;
  ...
  _proto.deleteRule = function deleteRule(index2) {
    this.sheet.deleteRule(index2);
    this.length--;
  };
  _proto.getRule = function getRule(index2) {
    var rule = this.sheet.cssRules[index2];
...
var TextTag = function() {
  ...
  _proto2.insertRule = function insertRule(index2, rule) {
    if (index2 <= this.length && index2 >= 0) {
      var node = document.createTextNode(rule);
      var refNode = this.nodes[index2];
  ...
  _proto2.deleteRule = function deleteRule(index2) {
    this.element.removeChild(this.nodes[index2]);
    this.length--;
  };
  _proto2.getRule = function getRule(index2) {
    if (index2 < this.length) {
      return this.nodes[index2].textContent;
    } else {
      return "";
    }
  };
...
var VirtualTag = function() {
  ...
  _proto3.insertRule = function insertRule(index2, rule) {
    if (index2 <= this.length) {
      this.rules.splice(index2, 0, rule);
      this.length++;
      return true;
    } else {
      return false;
  ...
  _proto3.deleteRule = function deleteRule(index2) {
    this.rules.splice(index2, 1);
    this.length--;
  };
  _proto3.getRule = function getRule(index2) {
    if (index2 < this.length) {
      return this.rules[index2];
    } else {
      return "";
    }
  };
...
function createStylisInstance(_temp) {
  ...
  var stylis = new stylis_browser_esm_default(options);
  var parsingRules = [];
...
var StyleSheetContext = import_react.default.createContext();
var StyleSheetConsumer = StyleSheetContext.Consumer;
var StylisContext = import_react.default.createContext();
var StylisConsumer = StylisContext.Consumer;
var masterSheet = new StyleSheet();
var masterStylis = createStylisInstance();
function useStyleSheet() {
  return (0, import_react.useContext)(StyleSheetContext) || masterSheet;
}
function useStylis() {
  return (0, import_react.useContext)(StylisContext) || masterStylis;
}
function StyleSheetManager(props) {
  var _useState = (0, import_react.useState)(props.stylisPlugins), plugins = _useState[0], setPlugins = _useState[1];
  var contextStyleSheet = useStyleSheet();
  var styleSheet = (0, import_react.useMemo)(function() {
  ...
  var stylis = (0, import_react.useMemo)(function() {
  ...
  (0, import_react.useEffect)(function() {
    if (!(0, import_shallowequal.default)(plugins, props.stylisPlugins))
      setPlugins(props.stylisPlugins);
  }, [props.stylisPlugins]);
  return import_react.default.createElement(StyleSheetContext.Provider, {
    value: styleSheet
  }, import_react.default.createElement(StylisContext.Provider, {
    value: stylis
  }, true ? import_react.default.Children.only(props.children) : props.children));
}
...
function ThemeProvider(props) {
  var outerTheme = (0, import_react.useContext)(ThemeContext);
  var themeContext = (0, import_react.useMemo)(function() {
...
function useInjectedStyle(componentStyle, hasAttrs, resolvedAttrs, warnTooManyClasses) {
  ...
  (0, import_react.useDebugValue)(className);
...
function useStyledComponentImpl(forwardedComponent, props, forwardedRef) {
  ...
  (0, import_react.useDebugValue)(styledComponentId);
  var theme = determineTheme(props, (0, import_react.useContext)(ThemeContext), defaultProps);
  ...
  var generatedClassName = useInjectedStyle(componentStyle, componentAttrs.length > 0, context, true ? forwardedComponent.warnTooManyClasses : void 0);
  var refToForward = forwardedRef;
  var elementToBeCreated = attrs.$as || props.$as || attrs.as || props.as || target;
  var isTargetTag = isTag(elementToBeCreated);
  var computedProps = attrs !== props ? _extends({}, props, {}, attrs) : props;
  var propFilterFn = shouldForwardProp || isTargetTag && is_prop_valid_browser_esm_default;
  var propsForElement = {};
  for (var key in computedProps) {
    ...
    } else if (!propFilterFn || propFilterFn(key, is_prop_valid_browser_esm_default)) {
...
function createStyledComponent(target, options, rules) {
  ...
  if (isCompositeComponent) {
    (0, import_hoist_non_react_statics.default)(WrappedStyledComponent, target, {
      attrs: true,
      componentStyle: true,
      displayName: true,
...
function createGlobalStyle(strings) {
  ...
  return import_react.default.memo(GlobalStyleComponent);
}
...
var ServerStyleSheet = function() {
  function ServerStyleSheet2() {
    ...
    this.getStyleElement = function() {
      ...
      return [import_react.default.createElement("style", _extends({}, props, {
        key: "sc-0-0"
      }))];
    };
    this.seal = function() {
  ...
  _proto.collectStyles = function collectStyles(children) {
    ...
    return import_react.default.createElement(StyleSheetManager, {
      sheet: this.instance
    }, children);
  };
...
var withTheme = function(Component) {
  ...
  (0, import_hoist_non_react_statics.default)(WithTheme, Component);
